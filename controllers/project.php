<?php
    ...
    function project_view()
    {
        ...
        if ($project != null)
        {
            ...
            while($row = mysql_fetch_array($result))
            {
                ...
                $body .= "<h3>#$row[number]&nbsp;&nbsp;<a href='/issue/$row[id]'>" . FriendlyString($row[title], 66) . "</a></h3>";
                $body .= "</td>\n";
    ...
    function project_list()
    {
        ...
        while($row = mysql_fetch_array($result))
        {
            ...
            $body .= "<td width='100%'>\n";
            $body .= "<h3><a href='/project/$row[id]'>" . FriendlyString($row['name'], 62) . "</a></h3><br />\n";
            $body .= "<p>" . FriendlyString($row['description'], 85) . "</p>\n";
            $body .= "</td>\n";
