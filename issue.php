        ...
        <div class="list"> 
            ...
            <div class="list-item issue">
                ...
                <div class="options">
                    ...
                    <a class="minibutton minidanger" onclick="return confirm('Are you sure you want to delete this issue and all of its comments?');" href='issue-delete.php?id=<?php echo $issue[id]; ?>&projectid=<?php echo $issue[projectid]; ?>'><span>Delete</span></a>
            ...
            <?php
                ...
                while($row = mysql_fetch_array($result))
                {
                    ...
                    echo "<a class='minibutton minidanger' postback='comment-delete.php?id=$row[id]&issueid=$row[issueid]'><span>Delete</span></a>\n";
